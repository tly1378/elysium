...
namespace SurvivalEngine
{
    ...
    public class TheUI : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            network.onBeforeChangeScene += OnChangeScene;
        ...
        public bool IsInsideCamera(Vector2 pos)
        {
            return canvas.worldCamera.pixelRect.Contains(pos);
        }

        public Vector2 WorldToScreenPos(Vector3 world)
        {
            return canvas.worldCamera.WorldToScreenPoint(world);
        }
