...
namespace SurvivalEngine
{
    ...
    public class UISlot : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
    {
        ...
        private Dictionary<int, string> shortkeys = new Dictionary<int, string>();
        ...
        protected virtual void Update()
        {
            ...
            if (key_index == 10)
                key_index = 0;
            if (key_index >= 0 && key_index < 10 && PlayerControls.Get().IsPressedByName(shortkeys[key_index]))
            {
                if (onPressKey != null)
