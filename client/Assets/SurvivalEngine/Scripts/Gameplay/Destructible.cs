...
namespace SurvivalEngine
{
    ...
    public class Destructible : AttackTarget
    {
        ...
        private static LinkedList<Destructible> active_list = new LinkedList<Destructible>();
        private LinkedListNode<Destructible> node;

        protected override void Awake()
        {
            base.Awake();

            node = new LinkedListNode<Destructible>(this);
        ...
        public static LinkedList<Destructible> GetAllActive()
        {
            return active_list;
        }
    }
