...
namespace SurvivalEngine
{
    ...
    public class Spawner : MonoBehaviour
    {
        ...
        {
            if (WorldData.Get().HasCustomFloat(GetTimerUID()))
                spawn_timer = WorldData.Get().GetCustomFloat(GetTimerUID());
        }
        ...
        void Update()
        {
            ...
            WorldData.Get().SetCustomFloat(GetTimerUID(), spawn_timer);
        ...
        public int CountObjectsInRange()
        {
            ...
            {
                count += Craftable.CountObjectInRadius(data, transform.position, spawn_max_radius);
            }
            return count;
        }
