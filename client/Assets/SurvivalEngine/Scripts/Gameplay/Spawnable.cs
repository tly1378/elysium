...
namespace SurvivalEngine
{
    ...
    public class Spawnable : SObject
    {
        ...
        {
            SpawnedData sdata = WorldData.Get().GetSpawnedObject(uid);
        ...
        public static GameObject Create(SpawnData data, Vector3 pos, Quaternion rot, float scale)
        {
            ...
            {
                SpawnedData sdata = WorldData.Get().AddSpawnedObject(data.id, SceneNav.GetCurrentScene(), pos, rot, scale);
