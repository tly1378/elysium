...
namespace SurvivalEngine
{
    ...
    public class Character : Craftable
    {
        ...
        private static LinkedList<Character> character_list = new LinkedList<Character>();
        private LinkedListNode<Character> node;

        protected override void Awake()
        {
            base.Awake();
            node = character_list.AddLast(this);
        ...
        public static LinkedList<Character> GetAll()
        {
        ...
        public static Character CreateBuildMode(CharacterData data, Vector3 pos)
        {
            ...
            character.data = data;
            character.unique_id.was_created = true;
            character.NetObject.SetOptimizerEnabled(false); //Disable optimizer while in build mode
            return character;
        }
