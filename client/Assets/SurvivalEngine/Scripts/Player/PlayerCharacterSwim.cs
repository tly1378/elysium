...
namespace SurvivalEngine
{
    ...
    public class PlayerCharacterSwim : MonoBehaviour
    {
        ...
        private List<int> cground_layers = new List<int>();
        ...
        private void FixedUpdate()
        {
            ...
            PhysicsTool.DetectGroundLayers(center, hradius, cground_layers);
        ...
        private void StartSwim()
        {
            if (!is_swimming)
            {
                ...
                TheAudio.Get().PlaySFX3D("character", swim_start_audio, transform.position);
            }
        }
